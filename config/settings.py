...
class Settings(BaseModel):
    ...
    # Position Sizing & Account Risk (₹4,200 Margin, 6x Leverage -> ₹25,200 Position Size)
    ACCOUNT_EQUITY: float = float(os.getenv("ACCOUNT_EQUITY", "4200.0"))
    ...
    MAX_DAILY_LOSS: float = float(os.getenv("MAX_DAILY_LOSS", "420.0"))
